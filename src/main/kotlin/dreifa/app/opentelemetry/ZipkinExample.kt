...
import dreifa.app.opentelemetry.ExampleConfiguration.initializeOpenTelemetry
...
class ZipkinExample(tracerProvider: TracerProvider) {
    ...
    private val tracer: Tracer = tracerProvider["io.opentelemetry.example.ZipkinExample"]
